          ...
          {isSupabaseConfigured ? (
            <div className="mb-6 space-y-3">
              <button
                ...
                disabled={loading}
                className="flex w-full items-center overflow-hidden rounded-none bg-[#24292f] text-left text-white shadow-sm transition-opacity hover:opacity-95 disabled:opacity-60"
              >
                ...
                <span className="flex-1 px-4 py-3 text-center text-lg font-medium sm:text-xl">
                  Sign in with GitHub
                </span>
              </button>
              <button
                ...
                disabled={loading}
                className="flex w-full items-center overflow-hidden rounded-none bg-[#4285f4] text-left text-white shadow-sm transition-opacity hover:opacity-95 disabled:opacity-60"
              >
                <span className="flex h-11 w-14 shrink-0 items-center justify-center bg-white">
