          ...
          {isSupabaseConfigured ? (
            <div className="mb-6 space-y-3">
              ...
              <button
                ...
                disabled={loading}
                className="flex w-full items-center overflow-hidden rounded-lg bg-[#4285f4] text-left text-white shadow-sm transition-opacity hover:opacity-95 disabled:opacity-60"
              >
                <span className="flex h-10 w-12 shrink-0 items-center justify-center bg-white">
